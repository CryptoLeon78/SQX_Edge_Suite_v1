...
try:
    import pandas as pd
except ImportError as exc:  # optional analysis dependency
    pd = None
...
def main(tf: str = "H1", metrics_path: Path | None = None, out_path: Path | None = None,
...
if __name__ == "__main__":
    ...
    p.add_argument("--inject", action="store_true",
                   help="Actualiza el HTML si existe un bloque scores-data compatible")
    args = p.parse_args()
    main(
        tf=args.tf,
