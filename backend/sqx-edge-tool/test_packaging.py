...
class EmbeddedPackagingTestCase(unittest.TestCase):
    def test_embedded_launchers_and_tools_exist(self):
        expected = [
            ...
            TOOL_ROOT / "tools" / "next_controlled_commercial_movement_from_m98_decision.py",
    ...
    def test_portable_package_includes_embedded_runtime(self):
        ...
        self.assertIn("next_controlled_commercial_movement_from_m98_decision\\.py", text)
        ...
        self.assertIn('"next_controlled_commercial_movement_from_m98_decision"', text)
    ...
    def test_gitignore_guards_local_license_file(self):
        ...
        self.assertIn("backend/sqx-edge-tool/data/next_controlled_commercial_movement_from_m98_decision/", text)
