...
class DashboardStaticTestCase(unittest.TestCase):
    ...
    def test_workflow_shell_delegates_to_workflow_module(self):
        ...
        self.assertIn("Capa 2 centralizada en el pipeline", workflow_capa2)
        self.assertIn("3 - Mining 2 - Capa 2 sobre Template", workflow_capa2)
        ...
        self.assertNotIn("Checklist de aplicación Capa 2", workflow_capa2)
