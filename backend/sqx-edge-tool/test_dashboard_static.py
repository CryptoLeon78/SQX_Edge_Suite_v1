...
class DashboardStaticTestCase(unittest.TestCase):
    ...
    def test_modular_scaffold_loads_before_legacy_logic(self):
        ...
        self.assertIn('id="vc-saved-details"', self.html)
        self.assertIn('id="vc-metrics-details"', self.html)
        self.assertIn("Ajustes avanzados", self.html)
        self.assertIn("Mis presets", self.html)
        self.assertIn("Editar métricas avanzadas", self.html)
        self.assertIn("views-preset-primary", self.html)
        self.assertIn("views-preset-reset", self.html)
    ...
    def test_workflow_shell_delegates_to_workflow_module(self):
        ...
        self.assertIn('aria-live="polite"', pipeline_tab)
        ...
        self.assertIn("Period: 2017.10 - 2026.04", self.html)
        ...
        self.assertIn("Period: 2024.01 - 2026.04", self.html)
        ...
        self.assertIn("renderPsOperationalFocus", dashboard_js)
