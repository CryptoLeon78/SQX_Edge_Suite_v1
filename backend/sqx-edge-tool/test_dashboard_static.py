...
class DashboardStaticTestCase(unittest.TestCase):
    ...
    def test_fulfillment_operator_module_and_ui_are_wired(self):
        ...
        self.assertEqual(product_manifest["upgrade"]["checkout"]["status"], "template_pack_2_sales_register_ready")
        self.assertEqual(product_manifest["upgrade"]["checkout"]["automation"]["status"], "template_pack_2_sales_register_ready")
