...
class DashboardStaticTestCase(unittest.TestCase):
    ...
    def test_strategy_builder_discovery_is_documented_before_runtime(self):
        ...
        self.assertIn("Current phase completed: M90 - Next controlled commercial movement decision.", governance)
    ...
    def test_fulfillment_operator_module_and_ui_are_wired(self):
        ...
        self.assertEqual(product_manifest["upgrade"]["checkout"]["status"], "next_controlled_commercial_movement_decision_ready")
        self.assertEqual(product_manifest["upgrade"]["checkout"]["automation"]["status"], "next_controlled_commercial_movement_decision_ready")
    ...
    def test_public_commercial_docs_are_redacted_and_traceable(self):
        ...
        self.assertEqual(manifest["phase"], "M90_next_controlled_commercial_movement_decision")
        self.assertEqual(manifest["latestPrivateCommercialPhase"], "M90")
