...
class DashboardStaticTestCase(unittest.TestCase):
    ...
    def test_monetization_docs_capture_m1_to_m50_decisions(self):
        ...
        m47 = MONETIZATION_M47_DOC.read_text(encoding="utf-8-sig")
        m48 = MONETIZATION_M48_DOC.read_text(encoding="utf-8-sig")
        m49 = MONETIZATION_M49_DOC.read_text(encoding="utf-8-sig")
        m50 = MONETIZATION_M50_DOC.read_text(encoding="utf-8-sig")
        m51 = MONETIZATION_M51_DOC.read_text(encoding="utf-8-sig")
        m52 = MONETIZATION_M52_DOC.read_text(encoding="utf-8-sig")
        m53 = MONETIZATION_M53_DOC.read_text(encoding="utf-8-sig")
        ...
        m58 = MONETIZATION_M58_DOC.read_text(encoding="utf-8-sig")
        m59 = MONETIZATION_M59_DOC.read_text(encoding="utf-8-sig")
        m60 = MONETIZATION_M60_DOC.read_text(encoding="utf-8-sig")
        m61 = MONETIZATION_M61_DOC.read_text(encoding="utf-8-sig")
        m62 = MONETIZATION_M62_DOC.read_text(encoding="utf-8-sig")
        m63 = MONETIZATION_M63_DOC.read_text(encoding="utf-8-sig")
        m64 = MONETIZATION_M64_DOC.read_text(encoding="utf-8-sig")
        m65 = MONETIZATION_M65_DOC.read_text(encoding="utf-8-sig")
        ...
        m70 = MONETIZATION_M70_DOC.read_text(encoding="utf-8-sig")
        ...
        pro_buyer_pack = (PROJECT_ROOT / "docs" / "sales" / "PRO_BUYER_PACK.md").read_text(encoding="utf-8-sig")
        buyer_onboarding_gate = (PROJECT_ROOT / "docs" / "sales" / "BUYER_ONBOARDING_SUPPORT_GATE.md").read_text(encoding="utf-8-sig")
        template_pack_1 = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_1_DELIVERY.md").read_text(encoding="utf-8-sig")
        template_pack_1_offer = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_1_PUBLIC_OFFER.md").read_text(encoding="utf-8-sig")
        template_pack_1_publication = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_1_LIVE_CHECKOUT_PUBLICATION.md").read_text(encoding="utf-8-sig")
        template_pack_1_purchase_drill = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_1_PURCHASE_DRILL.md").read_text(encoding="utf-8-sig")
        template_pack_1_handoff = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_1_HANDOFF.md").read_text(encoding="utf-8-sig")
        ...
        template_pack_2_assets = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_2_ASSETS.md").read_text(encoding="utf-8-sig")
        template_pack_2_offer_pack = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_2_OFFER_PACK.md").read_text(encoding="utf-8-sig")
        template_pack_2_publication = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_2_CONTROLLED_PUBLICATION.md").read_text(encoding="utf-8-sig")
        template_pack_2_purchase_drill = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_2_PURCHASE_DRILL.md").read_text(encoding="utf-8-sig")
        template_pack_2_handoff = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_2_HANDOFF.md").read_text(encoding="utf-8-sig")
        template_pack_2_sales_register = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_2_SALES_REGISTER.md").read_text(encoding="utf-8-sig")
        template_pack_2_feedback_cohort = (PROJECT_ROOT / "docs" / "sales" / "TEMPLATE_PACK_2_FEEDBACK_COHORT.md").read_text(encoding="utf-8-sig")
        buyer_ready_closeout = (PROJECT_ROOT / "docs" / "sales" / "BUYER_READY_CHECKOUT_RELEASE.md").read_text(encoding="utf-8-sig")
        ...
        next_buyer_readiness = (PROJECT_ROOT / "docs" / "sales" / "NEXT_CONTROLLED_BUYER_READINESS.md").read_text(encoding="utf-8-sig")
        ...
        self.assertIn("Phase M47", roadmap)
        self.assertIn("Phase M48", roadmap)
        self.assertIn("Phase M49", roadmap)
        self.assertIn("Phase M50", roadmap)
        self.assertIn("Phase M51", roadmap)
        self.assertIn("Phase M52", roadmap)
        self.assertIn("Phase M53", roadmap)
        ...
        self.assertIn("Phase M58", roadmap)
        self.assertIn("Phase M59", roadmap)
        self.assertIn("Phase M60", roadmap)
        self.assertIn("Phase M61", roadmap)
        self.assertIn("Phase M62", roadmap)
        self.assertIn("Phase M63", roadmap)
        self.assertIn("Phase M64", roadmap)
        self.assertIn("Phase M65", roadmap)
        ...
        self.assertIn("Phase M70", roadmap)
        ...
        self.assertIn("Phase M47: prepare real Pro buyer data and templates with safe CSV import, asset universe, activation, support and first-value material. Done.", next_steps)
        self.assertIn("Phase M48: add a basic buyer onboarding and support gate for purchase, install, license activation, FAQ, support macro and refund/pause criteria. Done.", next_steps)
        self.assertIn("Phase M49: package Template Pack 1 as a controlled add-on with sample profiles, safe claims, delivery checklist and support boundaries. Done.", next_steps)
        self.assertIn("Phase M50: prepare public add-on offer, checkout variant wiring and delivery macro for Template Pack 1. Done.", next_steps)
        self.assertIn("Phase M51: connect real checkout URL, variant ID and support email through a controlled publication gate. Done.", next_steps)
        self.assertIn("Phase M52: run a controlled Template Pack 1 purchase drill and validate delivery/support evidence. Done.", next_steps)
        self.assertIn("Phase M53: execute post-purchase handoff, support follow-up and scale/pause decision. Done.", next_steps)
        ...
        self.assertIn("Phase M58: create Template Pack 2 initial assets from the specs gate. Done.", next_steps)
        self.assertIn("Phase M59: prepare Template Pack 2 offer pack with public copy, FAQ, checkout draft, delivery macro and support macro. Done.", next_steps)
        self.assertIn("Phase M60: prepare controlled Template Pack 2 publication with live checkout URL, support, rollback and purchase drill. Done.", next_steps)
        self.assertIn("Phase M61: execute Template Pack 2 controlled purchase drill with redacted payment, delivery, support and refund/pause evidence. Done.", next_steps)
        self.assertIn("Phase M62: prepare Template Pack 2 post-purchase handoff, first-value support and scale/pause decision. Done.", next_steps)
        self.assertIn("Phase M63: consolidate Template Pack 2 sales register and early cohort tracking before more traffic. Done.", next_steps)
        self.assertIn("Phase M64: review Template Pack 2 early buyer feedback, support signals, refunds and scale decision. Done.", next_steps)
        self.assertIn("Phase M65: close buyer-ready checkout, release, support and delivery readiness for controlled first sales. Done.", next_steps)
        ...
        self.assertIn("Phase M70: run the next controlled buyer readiness check before sharing another private checkout link. Done.", next_steps)
        ...
        m47_patterns = [
            ...
            "strategy_import_template.csv",
            "Estado: Done.",
        ]
        for pattern in m47_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m47)
        self.assertIn("Pro Buyer Pack", pro_buyer_pack)
        self.assertIn("28 Forex, 4 indices y oro", pro_buyer_pack)
        self.assertIn("payloads de licencia", pro_buyer_pack.lower())

        m48_patterns = [
            "buyer_onboarding_support_gate_ready",
            "buyer_onboarding_support_gate.py",
            "resources/pro-buyer-pack/onboarding",
            "START_HERE.md",
            "Estado: Done.",
        ]
        for pattern in m48_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m48)
        self.assertIn("Buyer Onboarding Support Gate", buyer_onboarding_gate)
        self.assertIn("refund_or_pause", buyer_onboarding_gate)
        self.assertIn("resultados financieros", buyer_onboarding_gate)
        ...
        for pattern in m49_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m49)
        self.assertIn("Template Pack 1 Delivery", template_pack_1)
        self.assertIn("one_time_addon", json.dumps(json.loads((TOOL_ROOT / "config" / "product_manifest.json").read_text(encoding="utf-8-sig"))))
        self.assertIn("Setup Assist", template_pack_1)

        m50_patterns = [
            "template_pack_1_public_offer_ready",
            "template_pack_1_offer.py",
            "resources/pro-template-pack-1/offer",
            "checkout",
            "Estado: Done.",
        ]
        for pattern in m50_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m50)
        self.assertIn("Template Pack 1 Public Offer", template_pack_1_offer)
        self.assertIn("template_pack_1", template_pack_1_offer)
        self.assertIn("49 EUR", template_pack_1_offer)

        m51_patterns = [
            "template_pack_1_live_checkout_gate_ready",
            "template_pack_1_publication.py",
            "TEMPLATE_PACK_1_LIVE_CHECKOUT_PUBLICATION.md",
            "provider variant ID",
            "Estado: Done.",
        ]
        for pattern in m51_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m51)
        self.assertIn("Template Pack 1 Live Checkout Publication", template_pack_1_publication)
        self.assertIn("SQX_TEMPLATE_PACK_1_CHECKOUT_URL", template_pack_1_publication)
        self.assertIn("--apply", template_pack_1_publication)

        m52_patterns = [
            "template_pack_1_purchase_drill_ready",
            "template_pack_1_purchase_drill.py",
            "TEMPLATE_PACK_1_PURCHASE_DRILL.md",
            "store_redacted_buyer_email_and_order_reference_only",
            "Estado: Done.",
        ]
        for pattern in m52_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m52)
        self.assertIn("Template Pack 1 Purchase Drill", template_pack_1_purchase_drill)
        self.assertIn("--provider-order-id", template_pack_1_purchase_drill)
        self.assertIn("--require-delivery-package", template_pack_1_purchase_drill)

        m53_patterns = [
            "template_pack_1_handoff_ready",
            "template_pack_1_handoff.py",
            "TEMPLATE_PACK_1_HANDOFF.md",
            "store_redacted_buyer_reference_handoff_notes_and_scale_decision_only",
            "Estado: Done.",
        ]
        for pattern in m53_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m53)
        self.assertIn("Template Pack 1 Post-Purchase Handoff", template_pack_1_handoff)
        self.assertIn("--scale-decision", template_pack_1_handoff)
        self.assertIn("pause_sales", template_pack_1_handoff)

        m54_patterns = [
            "template_pack_1_sales_register_ready",
            "template_pack_1_sales_register.py",
            "TEMPLATE_PACK_1_SALES_REGISTER.md",
            "store_redacted_buyer_reference_order_status_support_metrics_and_scale_decision_only",
            "Estado: Done.",
        ]
        for pattern in m54_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m54)
        self.assertIn("Template Pack 1 Add-On Sales Register", template_pack_1_sales_register)
        self.assertIn("--append-register", template_pack_1_sales_register)
        self.assertIn("scale_limited", template_pack_1_sales_register)

        m55_patterns = [
            "template_pack_1_feedback_cohort_ready",
            "template_pack_1_feedback_cohort.py",
            "TEMPLATE_PACK_1_FEEDBACK_COHORT.md",
            "store_redacted_cohort_metrics_feedback_themes_support_counts_and_roadmap_decision_only",
            "Estado: Done.",
        ]
        for pattern in m55_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m55)
        self.assertIn("Template Pack 1 Feedback Cohort Review", template_pack_1_feedback_cohort)
        self.assertIn("--roadmap-decision", template_pack_1_feedback_cohort)
        self.assertIn("build_template_pack_2", template_pack_1_feedback_cohort)

        m56_patterns = [
            "template_pack_1_action_plan_ready",
            "template_pack_1_action_plan.py",
            "TEMPLATE_PACK_1_ACTION_PLAN.md",
            "store_redacted_action_plan_owner_priority_support_claims_distribution_and_next_phase_only",
            "Estado: Done.",
        ]
        for pattern in m56_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m56)
        self.assertIn("Template Pack 1 Action Plan", template_pack_1_action_plan)
        ...
        m58_patterns = [
            "template_pack_2_assets_ready",
            "template_pack_2_assets.py",
            "TEMPLATE_PACK_2_ASSETS.md",
            "resources/pro-template-pack-2",
            "Estado: Done.",
        ]
        for pattern in m58_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m58)
        self.assertIn("Template Pack 2 Assets", template_pack_2_assets)
        self.assertIn("--use-latest-specs", template_pack_2_assets)
        self.assertIn("M59_template_pack_2_offer_pack", template_pack_2_assets)

        m59_patterns = [
            "template_pack_2_offer_pack_ready",
            "template_pack_2_offer_pack.py",
            "TEMPLATE_PACK_2_OFFER_PACK.md",
            "resources/pro-template-pack-2/offer",
            "Estado: Done.",
        ]
        for pattern in m59_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m59)
        self.assertIn("Template Pack 2 Offer Pack", template_pack_2_offer_pack)
        self.assertIn("template_pack_2", template_pack_2_offer_pack)
        self.assertIn("79 EUR", template_pack_2_offer_pack)

        m60_patterns = [
            "template_pack_2_controlled_publication_ready",
            "template_pack_2_publication.py",
            "TEMPLATE_PACK_2_CONTROLLED_PUBLICATION.md",
            "--apply",
            "Estado: Done.",
        ]
        for pattern in m60_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m60)
        self.assertIn("Template Pack 2 Controlled Publication", template_pack_2_publication)
        self.assertIn("SQX_TEMPLATE_PACK_2_CHECKOUT_URL", template_pack_2_publication)
        self.assertIn("purchase drill", template_pack_2_publication)

        m61_patterns = [
            "template_pack_2_purchase_drill_ready",
            "template_pack_2_purchase_drill.py",
            "TEMPLATE_PACK_2_PURCHASE_DRILL.md",
            "redacted buyer evidence",
            "Estado: Done.",
        ]
        for pattern in m61_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m61)
        self.assertIn("Template Pack 2 Purchase Drill", template_pack_2_purchase_drill)
        self.assertIn("--require-delivery-package", template_pack_2_purchase_drill)
        self.assertIn("79.00", template_pack_2_purchase_drill)

        m62_patterns = [
            "template_pack_2_handoff_ready",
            "template_pack_2_handoff.py",
            "TEMPLATE_PACK_2_HANDOFF.md",
            "scale_limited",
            "Estado: Done.",
        ]
        for pattern in m62_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m62)
        self.assertIn("Template Pack 2 Post-Purchase Handoff", template_pack_2_handoff)
        self.assertIn("--scale-decision", template_pack_2_handoff)
        self.assertIn("pause_sales", template_pack_2_handoff)

        m63_patterns = [
            "template_pack_2_sales_register_ready",
            "template_pack_2_sales_register.py",
            "TEMPLATE_PACK_2_SALES_REGISTER.md",
            "keep_tracking",
            "Estado: Done.",
        ]
        for pattern in m63_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m63)
        self.assertIn("Template Pack 2 Add-On Sales Register", template_pack_2_sales_register)
        self.assertIn("--append-register", template_pack_2_sales_register)
        self.assertIn("scale_limited", template_pack_2_sales_register)

        m64_patterns = [
            "template_pack_2_feedback_cohort_ready",
            "template_pack_2_feedback_cohort.py",
            "TEMPLATE_PACK_2_FEEDBACK_COHORT.md",
            "prepare_pack_3",
            "Estado: Done.",
        ]
        for pattern in m64_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m64)
        self.assertIn("Template Pack 2 Feedback Cohort Review", template_pack_2_feedback_cohort)
        self.assertIn("--roadmap-decision", template_pack_2_feedback_cohort)
        self.assertIn("pause_sales", template_pack_2_feedback_cohort)

        m65_patterns = [
            "buyer_ready_checkout_release_closeout_ready",
            "buyer_ready_checkout_closeout.py",
            "BUYER_READY_CHECKOUT_RELEASE.md",
            "keep_private_pilot",
            "Estado: Done.",
        ]
        for pattern in m65_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m65)
        self.assertIn("Buyer-Ready Checkout Release Closeout", buyer_ready_closeout)
        self.assertIn("--confirm-license-delivery-reviewed", buyer_ready_closeout)
        self.assertIn("pause_sales", buyer_ready_closeout)

        m66_patterns = [
            "public_buyer_page_cadence_ready",
            "public_buyer_page_cadence.py",
            "PUBLIC_BUYER_PAGE_CADENCE.md",
            "publish_private_page",
            "Estado: Done.",
        ]
        for pattern in m66_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m66)
        self.assertIn("Public Buyer Page Checklist And First-Sale Cadence", public_buyer_page)
        self.assertIn("--confirm-first-sale-cadence-reviewed", public_buyer_page)
        self.assertIn("pause_sales", public_buyer_page)

        m67_patterns = [
            "first_controlled_buyer_log_ready",
            "first_controlled_buyer_log.py",
            "FIRST_CONTROLLED_BUYER_LOG.md",
            "schedule_followup",
            "Estado: Done.",
        ]
        for pattern in m67_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m67)
        self.assertIn("First Controlled Buyer Operating Log And Post-Sale Review", first_buyer_log)
        self.assertIn("--confirm-license-activation-reviewed", first_buyer_log)
        self.assertIn("pause_sales", first_buyer_log)

        m68_patterns = [
            "post_sale_improvement_loop_ready",
            "post_sale_improvement_loop.py",
            "POST_SALE_IMPROVEMENT_LOOP.md",
            "ship_micro_updates",
            "Estado: Done.",
        ]
        for pattern in m68_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m68)
        ...
        m70_patterns = [
            ...
            "NEXT_CONTROLLED_BUYER_READINESS.md",
            "share_private_link",
            "Estado: Done.",
        ]
        for pattern in m70_patterns:
            with self.subTest(pattern=pattern):
                self.assertIn(pattern, m70)
        self.assertIn("Next Controlled Buyer Readiness Check", next_buyer_readiness)
        self.assertIn("--confirm-followup-window-recorded", next_buyer_readiness)
        self.assertIn("pause_sales", next_buyer_readiness)
    ...
    def test_pro_buyer_pack_resources_and_validator_are_present(self):
        ...
        strategy_csv = (pack_root / "data" / "strategy_import_template.csv").read_text(encoding="utf-8-sig")
        asset_csv = (pack_root / "data" / "asset_universe_pro.csv").read_text(encoding="utf-8-sig")
        self.assertIn("Strategy Name;Net profit;Profit factor", strategy_csv)
        self.assertEqual(len([line for line in asset_csv.splitlines() if line.strip()]) - 1, 33)
        for pattern in (
    ...
    def test_buyer_onboarding_support_gate_resources_and_validator_are_present(self):
        ...
        start_here = (onboarding_root / "START_HERE.md").read_text(encoding="utf-8-sig")
        faq = (onboarding_root / "faq_basic_user.md").read_text(encoding="utf-8-sig")
        self.assertIn("START_SQX_EDGE.bat", start_here)
        self.assertIn("Cargar licencia", start_here)
        self.assertIn("No. SQX Edge es una herramienta de productividad", faq)
        for pattern in (
            "buyer_onboarding_support_gate_ready",
    ...
    def test_template_pack_1_resources_and_packager_are_present(self):
        ...
        for profile_path in profiles:
            ...
            for field in config["profileRequiredFields"]:
                with self.subTest(profile=profile_path.name, field=field):
                    self.assertIn(field, profile)

        preset_csv = (pack_root / "presets" / "strategy_import_template_pack_1.csv").read_text(encoding="utf-8-sig")
        self.assertIn("Template;Use Case;Asset Class", preset_csv)
        for pattern in (
            "template_pack_1_delivery_ready",
    ...
    def test_template_pack_1_offer_resources_and_gate_are_present(self):
        ...
        public_offer = (offer_root / "public_offer.md").read_text(encoding="utf-8-sig")
        faq = (offer_root / "faq.md").read_text(encoding="utf-8-sig")
        self.assertIn("Template Pack 1 para SQX Edge Pro", public_offer)
        self.assertIn("Buyer Steps", public_offer)
        self.assertIn("Delivery Macro", public_offer)
        self.assertIn("Support Macro", public_offer)
        self.assertIn("ZIP add-on separado", faq)
        for pattern in (
            "template_pack_1_public_offer_ready",
    ...
    def test_template_pack_2_assets_gate_is_present(self):
        ...
        csv_text = (resource_dir / "presets" / "strategy_import_template_pack_2.csv").read_text(encoding="utf-8-sig")
        self.assertIn("Asset Family", csv_text)
        self.assertGreaterEqual(len(csv_text.strip().splitlines()) - 1, 8)
    ...
    def test_template_pack_2_offer_pack_resources_and_gate_are_present(self):
        ...
        public_offer = (offer_root / "public_offer.md").read_text(encoding="utf-8-sig")
        faq = (offer_root / "faq.md").read_text(encoding="utf-8-sig")
        checkout = (offer_root / "checkout_wiring.md").read_text(encoding="utf-8-sig")
        self.assertIn("Template Pack 2 para SQX Edge Pro", public_offer)
        self.assertIn("Buyer Steps", public_offer)
        self.assertIn("Delivery Macro", public_offer)
        self.assertIn("Support Macro", public_offer)
        self.assertIn("ZIP add-on separado", faq)
        self.assertIn("template_pack_2", checkout)
        self.assertIn("79 EUR", checkout)
        for pattern in (
            "template_pack_2_offer_pack_ready",
