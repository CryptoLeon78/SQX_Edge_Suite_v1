...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Ingest private REMOTE-ACCEPT1 real-browser evidence and emit a redacted summary."
    )
    parser.add_argument(
        "--evidence",
        default=str(DEFAULT_REMOTE_ACCEPT1_EVIDENCE_PATH),
        help="Ignored local REMOTE-ACCEPT1 private evidence JSON.",
    )
    parser.add_argument(
        "--out-dir",
        default=str(DEFAULT_REMOTE_ACCEPT1_OUTPUT_ROOT),
