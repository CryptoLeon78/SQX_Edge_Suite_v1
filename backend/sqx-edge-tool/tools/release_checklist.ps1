...
function Test-PortableZip {
  ...
  try {
    ...
    Assert-DirExcluded (Join-Path $TempRoot "backend\sqx-edge-tool\tools\approved_controlled_commercial_movement_from_m96_decision_execution.py")
    Assert-DirExcluded (Join-Path $TempRoot "backend\sqx-edge-tool\tools\approved_controlled_commercial_movement_from_m96_decision_execution_monitor.py")
    Assert-DirExcluded (Join-Path $TempRoot "backend\sqx-edge-tool\tools\next_controlled_commercial_movement_from_m98_decision.py")
    ...
    Assert-DirExcluded (Join-Path $TempRoot "backend\sqx-edge-tool\data\approved_controlled_commercial_movement_from_m96_decision_execution")
    Assert-DirExcluded (Join-Path $TempRoot "backend\sqx-edge-tool\data\approved_controlled_commercial_movement_from_m96_decision_execution_monitor")
    Assert-DirExcluded (Join-Path $TempRoot "backend\sqx-edge-tool\data\next_controlled_commercial_movement_from_m98_decision")
