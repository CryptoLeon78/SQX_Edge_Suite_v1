(function(global) {
  ...
  SQX.moduleOrder = SQX.moduleOrder || ['core', 'config', 'storage', 'state-backup', 'license', 'ui', 'formatters', 'domain', 'datasets', 'champion-challenger-core', 'champion-challenger-regime', 'champion-challenger', 'strategy-builder-core', 'strategy-builder', 'renderers', 'charts', 'strategies', 'analyzer', 'home', 'support', 'fulfillment', 'customer-cockpit', 'workflow', 'view-creator', 'project-generator'];
