(function(global) {
  ...
  SQX.moduleOrder = SQX.moduleOrder || ['core', 'config', 'storage', 'modal-registry', 'state-backup', 'license', 'ui', 'formatters', 'domain', 'datasets', 'champion-challenger-core', 'champion-challenger-regime', 'champion-challenger', 'strategy-builder-core', 'strategy-builder', 'renderers', 'charts', 'strategies', 'exit-policy', 'template-maker-worker-client', 'template-maker', 'template-maker-ui', 'home', 'support', 'fulfillment', 'customer-cockpit', 'workflow', 'edge-factory', 'edge-factory-ui', 'view-creator', 'project-generator'];
