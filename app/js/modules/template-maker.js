(function(global) {
  ...
  var C2_BLOCKSETTINGS = {
    ...
    regime: 'BS_Regimen_v6',
    bs_regimen: 'BS_Regimen_v6',
    bs_regime: 'BS_Regimen_v6',
    bs_regimen_v4: 'BS_Regimen_v4',
    BS_Regimen_v4: 'BS_Regimen_v4',
    bs_regimen_v6: 'BS_Regimen_v6',
    BS_Regimen_v6: 'BS_Regimen_v6',
    sr: 'BS_SoporteResistencia_v6',
    soporte_resistencia: 'BS_SoporteResistencia_v6',
    soporteresistencia: 'BS_SoporteResistencia_v6',
    bs_soporte_resistencia: 'BS_SoporteResistencia_v6',
  ...
  function normalizeBlockSetting(value) {
    ...
    var blockManifest = global.SQX_MANIFEST && global.SQX_MANIFEST.blocksettings;
    var aliases = blockManifest && blockManifest.aliases || {};
    if (aliases[raw]) return aliases[raw];
    if (aliases[raw + '.sqb']) return aliases[raw + '.sqb'];
