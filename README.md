...
- Estado interno: T10ajn creo el shell Worker inocuo en `workers.dev`; la app real sigue sin desplegarse y Access queda pendiente de activacion/verificacion manual o API token con permisos Access.
