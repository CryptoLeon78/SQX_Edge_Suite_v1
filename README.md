...
- Estado interno: C1-CONFIG1 esta iniciado; Capa1 queda cerrada y `phase15_capa2_planning` queda planificada con `phase15_capa2_planning_20260524_190708.json`. Capa2 no se aplica todavia: primero toca `phase16_capa2_preflight_snapshot` para bloquear `ExitAfterBars` reintroducido por BlockSettings, reconciliar SL/TP/trailing y completar generator profile layer 2.
