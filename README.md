...
- Estado interno: WFCO-4 Portfolio Lab MVP esta aplicado; Edge Factory ya tiene un Lab Capa 2 real para importar CSV, ajustar diversidad, clasificar candidatos como portfolio/similar/revisar y exportar shortlist/resumen desde navegador.
...
- Siguiente paso recomendado: esperar el retest de TESTER-RILIS para REMOTE; en paralelo, continuar con WFCO-5 Visual Polish And Desktop QA para revisar Edge Factory completo en navegador PC real antes de nuevas capas funcionales. Si TESTER-RILIS confirma OK, registrar la incidencia como resuelta y reabrir REMOTE-8G decision review. Cualquier expansion, grant, email, checkout, URL o onboarding nuevo sigue bloqueado hasta una fase posterior aprobada.
