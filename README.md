...
- Estado interno: T10ac selecciona Cloudflare Pages preview + Cloudflare Access email OTP como candidata tester protegida sin desplegar.
...
- T10ac anade `proof:replacement-tester-route-options`; compara rutas no-Vercel y selecciona Cloudflare Pages preview + Cloudflare Access email OTP como candidata, sin crear proyecto, deploy, URL ni politicas externas.
