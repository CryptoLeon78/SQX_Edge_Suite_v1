...
- Estado interno: T10ajo verifica Cloudflare Access encima del shell Worker inocuo en `workers.dev`; la app real sigue sin desplegarse y no hay URL tester publicada.
