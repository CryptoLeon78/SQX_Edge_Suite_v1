...
- Estado interno: M80 completada; estado comercial vigente `manual_publication_monitor_ready`.
...
- Siguiente paso recomendado: preparar revision de expansion controlada solo si M80 no detecta riesgos.
