...
- Estado interno: T10ajf confirma que no hay ruta de shell Cloudflare invisible; el primer Worker requiere `wrangler deploy`/C3 con aprobacion exacta y T10ak sigue bloqueada.
