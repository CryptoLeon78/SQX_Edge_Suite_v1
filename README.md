...
- Estado interno: M78 completada; estado comercial vigente `operator_publication_review_ready`.
...
- Siguiente paso recomendado: preparar el registro de publicacion manual limitada solo si M78 aprueba.
