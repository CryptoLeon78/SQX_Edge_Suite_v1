...
- Estado interno: T10k ejecuto una preview CLI default corregida, Vercel volvio a devolver `target=production`, el guard bloqueo el build y el deployment fue eliminado.
