...
- Siguiente paso recomendado: esperar el retest de TESTER-RILIS para REMOTE; en paralelo, preparar una acceptance pass corta de Edge Factory o abordar CFX-METHOD2 cuando llegue la base Capa 2 v2. Si TESTER-RILIS confirma OK, registrar la incidencia como resuelta y reabrir REMOTE-8G decision review. Cualquier expansion, grant, email, checkout, URL o onboarding nuevo sigue bloqueado hasta una fase posterior aprobada.
