...
- Estado interno: T10d intento una preview API explicita y la elimino al detectar que Vercel devolvio `target=production`; no hay deployment activo ni URL compartida.
