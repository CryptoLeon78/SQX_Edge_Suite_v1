...
- Estado interno: T10ag confirma smoke local OpenNext/Cloudflare en WSL/Linux con `/api/health` 200, manteniendo nativo Windows como NO-GO de preview.
