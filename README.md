...
- Estado interno: T10ajg deja preparado el gate exacto para el primer `wrangler deploy` Cloudflare, sin ejecutarlo ni compartir URL; T10ak sigue bloqueada hasta shell real verificado.
