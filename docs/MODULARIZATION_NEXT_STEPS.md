...
33. Phase T10r: authenticate Vercel CLI or provide local `VERCEL_TOKEN`, then create or verify `sqx-edge-tester-staging` without deployment.
34. Phase T11: roll out to up to 10 testers with monitored access and manual renewal.
35. Phase T12: monitor abuse, failed logins, access patterns and continue/stop decision.
