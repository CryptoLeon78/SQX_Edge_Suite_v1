...
14. Phase T9f: prepare Git/PR-based preview or API deployment proof that cannot auto-alias production before any URL is shared.
15. Phase T10: run one internal tester pilot before inviting external testers.
16. Phase T11: roll out to up to 10 testers with monitored access and manual renewal.
17. Phase T12: monitor abuse, failed logins, access patterns and continue/stop decision.
