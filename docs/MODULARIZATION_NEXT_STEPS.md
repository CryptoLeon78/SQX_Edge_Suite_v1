...
23. Phase T10h: execute exactly one protected preview deployment from the separated project with immediate target inspection before any tester URL is shared.
24. Phase T11: roll out to up to 10 testers with monitored access and manual renewal.
25. Phase T12: monitor abuse, failed logins, access patterns and continue/stop decision.
