...
- Current completed phase: J8 - Temporal Health and EGT v2 pure helpers.
...
9. Phase J9: add compact dashboard chips and optional filters for Temporal Health and EGT v2.
