...
- Current completed phase: T10j - CLI Default Preview Command Rollback.
...
26. Phase T10k: execute exactly one CLI default preview deployment without `--skip-domain`, with immediate target inspection and rollback on mismatch. Do not share or commit any Vercel URL.
27. Phase T11: roll out to up to 10 testers with monitored access and manual renewal.
28. Phase T12: monitor abuse, failed logins, access patterns and continue/stop decision.
