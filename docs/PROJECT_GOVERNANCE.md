...
- Current phase completed: REMOTE-RUNBOOK1 - Operator Start/Stop. `START_SQX_EDGE_REMOTE.bat` and `STOP_SQX_EDGE_REMOTE.bat` now open a visual monitor for Backend/Tunnel state, hide service consoles and give the operator a clear pre-ACCEPT1 routine.
