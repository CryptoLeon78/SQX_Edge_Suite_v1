...
- REMOTE-ACCEPT1 real browser acceptance: `docs/REMOTE_ACCEPT1_BROWSER_ACCEPTANCE.md`, `remote-browser-acceptance-v1`, `docs/examples/remote_accept1_browser_acceptance.local.example.json`, ignored `.local/remote_service/remote_accept1_browser_acceptance*` evidence and `Real Browser Acceptance Gate`.
