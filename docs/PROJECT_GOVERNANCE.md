...
- Cloud Tester Access replacement decisions: `docs/T10AB_MANUAL_DASHBOARD_EVIDENCE_INGEST.md`, `docs/T10AC_REPLACEMENT_TESTER_ROUTE_OPTIONS.md`, `docs/T10AD_CLOUDFLARE_ACCESS_PREFLIGHT.md`, Cloudflare Access preflight planning and no-deploy route selection before any tester URL.
