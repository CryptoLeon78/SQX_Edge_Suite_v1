...
- REMOTE-RUNBOOK1 operator start/stop: `docs/REMOTE_RUNBOOK1_OPERATOR_START_STOP.md`, `START_SQX_EDGE_REMOTE.bat`, `STOP_SQX_EDGE_REMOTE.bat`, `tools/remote_operator_start.ps1`, `tools/remote_operator_stop.ps1`, `tools/remote_operator_status.ps1` and `tools/remote_operator_monitor.hta`.
