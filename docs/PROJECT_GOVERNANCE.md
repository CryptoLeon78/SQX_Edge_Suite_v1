...
- Current phase completed: REMOTE-8G - tiny cohort decision review, redacted and non-executing.
- Current implementation phase: REMOTE-8H - next controlled movement package, only if REMOTE-8G selected it.
