...
- Current phase completed: REMOTE-2B - tester-free entitlement and repository privacy gate before REMOTE-3 auth/payment implementation.
- Current implementation phase: REMOTE-3 - first-party auth, tester-free grants and paid webhook entitlement; no runtime auth work should ignore tester grants.
