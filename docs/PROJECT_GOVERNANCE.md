...
- Current implementation phase: EXIT-GATE1 - global SQX exit-method policy for Template Maker C2 generation, with controlled cleanup/randomization and traceable modal preview.
