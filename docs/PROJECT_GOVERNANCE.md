...
- Current phase completed: REMOTE-7 - web Pro monetization rewrite for monthly/annual access, no-install onboarding, tester-free access, support boundaries and buyer flow.
- Current implementation phase: REMOTE-8 - controlled pilot proving one user end to end through entitlement, login, workspace, artifact generation, export, revocation and restore.
