...
- Current phase completed: REMOTE-8F - tiny cohort monitoring and pause/rollback watch, redacted and non-automated.
- Current implementation phase: REMOTE-8G - tiny cohort decision review before any next controlled movement.
