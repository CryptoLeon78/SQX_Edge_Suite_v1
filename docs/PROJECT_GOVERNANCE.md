...
- Current phase completed: REMOTE-8L - post monitoring decision review, redacted and non-automated.
- Current implementation phase: REMOTE-8H cycle - package exactly one next movement only if REMOTE-8L selects `prepare_next_controlled_movement`.
