...
- Current phase completed: REMOTE-3C - signed payment webhook entitlement activation and protected write-endpoint pilot after app sessions.
- Current implementation phase: REMOTE-4 - server-derived workspace isolation for all remote mutable endpoints.
