...
- Current phase completed: REMOTE-6 - security and abuse controls for rate limits, revocation, redacted audit visibility, watermark and kill switch.
- Current implementation phase: REMOTE-7 - monetization rewrite for web Pro offer, onboarding, FAQ, support copy and buyer flow.
