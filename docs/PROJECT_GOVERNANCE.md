...
- Current implementation phase: TMA2-TMA5 - Template Maker metric contract with mandatory SQX Views `Template Maker Cert`; UX-NAV tab-by-tab optimization remains paused until this integration is verified.
...
- Next UX-NAV phase after TMA2-TMA5: resume tab-by-tab optimization; do not move to another UX tab until the operator says `Adelante con el siguiente tab`.
