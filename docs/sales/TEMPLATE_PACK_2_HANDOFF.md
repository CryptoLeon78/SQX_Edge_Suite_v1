# Template Pack 2 Post-Purchase Handoff

## Purpose

Use this runbook after the controlled purchase drill returns `GO`. It confirms delivery, first support contact and the decision to scale, hold or pause Template Pack 2 sales.
...
```powershell
backend\sqx-edge-tool\venv\Scripts\python.exe backend\sqx-edge-tool\tools\template_pack_2_handoff.py `
  ...
  --handoff-notes "Buyer received Template Pack 2 and first support window is open." `
