...
M91 continues this rule: approved controlled commercial movement execution details live privately, while public files keep traceability only.

M92 continues this rule: approved controlled commercial movement execution monitor details live privately, while public files keep traceability only.
...
M95 continues this rule: approved controlled commercial movement from M93 execution monitor details live privately, while public files keep traceability only.

M96 continues this rule: next controlled commercial movement from M95 decision details live privately, while public files keep traceability only.
...
M99 continues this rule: next controlled commercial movement from M98 decision details live privately, while public files keep traceability only.
