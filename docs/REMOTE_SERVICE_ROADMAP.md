...
Future controlled phase. It prepares the exact next movement package after REMOTE-8G but must still not execute traffic, checkout, grants, emails, onboarding or public URL sharing automatically.
