...
assert.equal(productManifest.upgrade.checkout.status, 'template_pack_2_offer_pack_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'template_pack_2_offer_pack_ready');
