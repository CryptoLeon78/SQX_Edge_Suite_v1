...
assert.equal(productManifest.upgrade.checkout.status, 'controlled_commercial_next_movement_execution_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'controlled_commercial_next_movement_execution_ready');
