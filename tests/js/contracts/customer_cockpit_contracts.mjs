...
assert.equal(productManifest.upgrade.checkout.status, 'manual_limited_publication_record_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'manual_limited_publication_record_ready');
