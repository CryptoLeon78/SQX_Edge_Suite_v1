...
assert.equal(productManifest.upgrade.checkout.status, 'private_asset_review_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'private_asset_review_ready');
