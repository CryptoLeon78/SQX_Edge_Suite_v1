...
assert.equal(productManifest.upgrade.checkout.status, 'first_controlled_buyer_log_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'first_controlled_buyer_log_ready');
