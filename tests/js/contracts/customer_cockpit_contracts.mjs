...
assert.equal(productManifest.upgrade.checkout.status, 'controlled_traffic_expansion_execution_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'controlled_traffic_expansion_execution_ready');
