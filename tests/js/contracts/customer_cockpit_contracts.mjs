...
assert.equal(productManifest.upgrade.checkout.status, 'operator_publication_review_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'operator_publication_review_ready');
