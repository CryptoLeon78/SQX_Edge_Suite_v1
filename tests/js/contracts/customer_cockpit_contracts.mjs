...
assert.equal(productManifest.upgrade.checkout.status, 'template_pack_1_delivery_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'template_pack_1_delivery_ready');
