...
assert.equal(productManifest.upgrade.checkout.status, 'controlled_traffic_expansion_review_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'controlled_traffic_expansion_review_ready');
