...
assert.equal(productManifest.upgrade.checkout.status, 'controlled_distribution_step_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'controlled_distribution_step_ready');
