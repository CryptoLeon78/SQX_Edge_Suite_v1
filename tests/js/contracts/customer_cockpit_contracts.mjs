...
assert.equal(productManifest.upgrade.checkout.status, 'template_pack_2_feedback_cohort_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'template_pack_2_feedback_cohort_ready');
