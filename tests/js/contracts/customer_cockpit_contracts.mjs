...
assert.equal(productManifest.upgrade.checkout.status, 'approved_controlled_commercial_movement_from_m93_execution_monitor_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'approved_controlled_commercial_movement_from_m93_execution_monitor_ready');
