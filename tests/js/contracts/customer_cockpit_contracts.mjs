...
assert.equal(productManifest.upgrade.checkout.status, 'next_controlled_commercial_movement_from_m95_decision_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'next_controlled_commercial_movement_from_m95_decision_ready');
