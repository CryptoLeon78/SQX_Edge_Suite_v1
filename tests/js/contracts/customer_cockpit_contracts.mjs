...
assert.equal(productManifest.upgrade.checkout.status, 'controlled_publication_gate_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'controlled_publication_gate_ready');
