...
assert.equal(productManifest.upgrade.checkout.status, 'manual_publication_monitor_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'manual_publication_monitor_ready');
