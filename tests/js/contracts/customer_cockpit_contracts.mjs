...
assert.equal(productManifest.upgrade.checkout.status, 'next_buyer_facing_asset_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'next_buyer_facing_asset_ready');
