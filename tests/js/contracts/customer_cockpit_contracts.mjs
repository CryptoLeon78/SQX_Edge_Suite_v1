...
assert.equal(productManifest.upgrade.checkout.status, 'public_buyer_page_cadence_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'public_buyer_page_cadence_ready');
