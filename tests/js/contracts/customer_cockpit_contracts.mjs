...
assert.equal(productManifest.upgrade.checkout.status, 'buyer_ready_checkout_release_closeout_ready');
assert.equal(productManifest.upgrade.checkout.automation.status, 'buyer_ready_checkout_release_closeout_ready');
