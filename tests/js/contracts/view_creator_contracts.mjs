...
assert.ok(viewCreator.buildTemplateMakerCertView().includes('name="Template Maker Cert"'));
...
assert.ok(viewCreator.buildCvcDecisionCertView().includes('name="CVC Decision Cert"'));
