...
assert.equal(productManifest.upgrade.checkout.status, 'release_publication_record_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'release_publication_record_ready');
