...
assert.equal(productManifest.upgrade.checkout.status, 'hotfix_rollback_release_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'hotfix_rollback_release_ready');
