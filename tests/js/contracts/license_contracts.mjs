...
assert.equal(productManifest.upgrade.checkout.status, 'checkout_live_readiness_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'checkout_live_readiness_ready');
