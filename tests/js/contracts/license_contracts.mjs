...
assert.equal(productManifest.upgrade.checkout.status, 'commercial_feedback_loop_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'commercial_feedback_loop_ready');
