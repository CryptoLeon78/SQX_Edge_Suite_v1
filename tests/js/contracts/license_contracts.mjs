...
assert.equal(productManifest.upgrade.checkout.status, 'public_release_gate_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'public_release_gate_ready');
