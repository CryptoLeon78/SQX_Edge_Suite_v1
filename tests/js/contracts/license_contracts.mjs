...
assert.equal(productManifest.upgrade.checkout.status, 'customer_cockpit_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'customer_cockpit_ready');
