...
assert.equal(productManifest.upgrade.checkout.status, 'customer_success_renewal_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'customer_success_renewal_ready');
