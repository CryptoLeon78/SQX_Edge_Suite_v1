...
assert.equal(productManifest.upgrade.checkout.status, 'template_pack_2_assets_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'template_pack_2_assets_ready');
