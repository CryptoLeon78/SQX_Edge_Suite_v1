...
assert.equal(productManifest.upgrade.checkout.status, 'public_offer_pack_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'public_offer_pack_ready');
