...
assert.equal(productManifest.upgrade.checkout.status, 'pilot_purchase_kit_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'pilot_purchase_kit_ready');
