...
assert.equal(productManifest.upgrade.checkout.status, 'commercial_release_candidate_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'commercial_release_candidate_ready');
