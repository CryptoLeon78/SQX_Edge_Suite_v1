...
assert.equal(productManifest.upgrade.checkout.status, 'launch_assets_kit_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'launch_assets_kit_ready');
