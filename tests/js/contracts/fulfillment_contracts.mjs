...
assert.equal(productManifest.upgrade.checkout.status, 'post_release_monitor_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'post_release_monitor_ready');
