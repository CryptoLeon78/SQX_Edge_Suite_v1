...
assert.equal(productManifest.upgrade.checkout.status, 'template_pack_2_specs_ready');
...
assert.equal(productManifest.upgrade.checkout.automation.status, 'template_pack_2_specs_ready');
