...
assert.match(core, /blocked_unsupported_candle_pattern/);
assert.match(core, /ASSET_ALIASES/);
assert.match(core, /_detect_candle_pattern/);
...
assert.match(overlayJs, /function hasDraftableSession\(\)/);
assert.match(overlayJs, /function issueCodes\(\)/);
...
assert.match(overlayJs, /Plan entendido, \.sqx bloqueado/);
assert.match(overlayJs, /blocked_unsupported_candle_pattern/);
assert.match(overlayJs, /blocked_unsupported_filter/);
